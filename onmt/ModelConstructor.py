...
def make_encoder(opt, embeddings):
    ...
    elif opt.encoder_type == "vae":
        return VaeEncoder(opt.rnn_type, opt.brnn, opt.dec_layers,
                          opt.rnn_size, opt.dropout, embeddings, opt.z_size)  ######################
...
def make_decoder(opt, embeddings):
    ...
    if opt.decoder_type == "transformer":
        ...
        return RNNDecoder(opt.rnn_type, opt.brnn,
                             opt.dec_layers, opt.rnn_size,
                             opt.global_attention,
                             opt.coverage_attn,
                             opt.context_gate,
