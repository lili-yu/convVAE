...
class Translator(object):
    ...
    def _runTarget(self, batch, data):
        ...
        cell_z = self.model.z2c(z).unsqueeze(0).repeat(self.model.n_layers, 1, 1)
        decStates = self.model.decoder.init_decoder_state(context, (enc_z,cell_z))
    ...
    def translateBatch(self, batch, dataset):
        ...
        return allHyps, allScores,  allGold
    ...
    def translate(self, batch, data):
        ...
        #  (2) translate
        pred, predScore, goldScore = self.translateBatch(batch, data) ##################
