...
def train_vae(model, train_data, valid_data, fields, optim):
    ...
    train_loss = onmt.Loss.VaeLossCompute(model.generator, model.encoder, fields["tgt"].vocab)
    valid_loss = onmt.Loss.VaeLossCompute(model.generator, model.encoder, fields["tgt"].vocab)
...
def main():
    ...
    # Do training.
    train_vae(model, train, valid, fields, optim)
